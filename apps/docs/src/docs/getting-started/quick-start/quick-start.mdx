...
The library re-exports styled-components API through `@juliensouki/seedui/sc`. Use this import for everything you would normally import from styled-components:
