...
This ensures you share the same styled-components instance as seedui, which is required for theming to work correctly. **Do not import directly from `styled-components`**.
