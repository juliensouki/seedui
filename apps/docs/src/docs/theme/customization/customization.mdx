...
The full shape of the theme object:
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <Td>
        <code>{'{ desktop?, tablet?, mobile? }'}</code>
      </Td>
      <Td>
        Override <code>fontSize</code> and <code>lineHeight</code> per breakpoint.
      </Td>
    </tr>
  </tbody>
</Table>
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <Td>
        An array of <code>{'{ condition, styles }'}</code> entries. Each <code>condition</code> receives{' '}
        <code>(props, theme)</code> and the styles are applied when it returns <code>true</code>.
      </Td>
    </tr>
  </tbody>
</Table>
